**FoodMicrobionet 4.2.1: Structure of edges and nodes tables**.
...
Future iterations of this table may contain further metadata on environmental variables (pH, aW, etc.) as measured or estimated values.
